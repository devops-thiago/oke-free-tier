...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=devops-thiago_oke-free-tier&metric=coverage)](https://sonarcloud.io/summary/new_code?id=devops-thiago_oke-free-tier)
...
- Multiple applications with custom domains
...
This project uses [Terratest](https://terratest.gruntwork.io/) for comprehensive infrastructure testing:
...
- ✅ **tfsec Security Scan**: Security vulnerability assessment
